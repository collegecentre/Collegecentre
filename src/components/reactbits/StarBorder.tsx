...
export const StarBorder: React.FC<StarBorderProps> = ({
  ...
  return (
    <Component
      className={cn(
        'relative inline-block py-[1px] overflow-hidden rounded-xl group select-none active:scale-[0.98] transition-transform',
        className
      )}
      {...props}
    >
      ...
      />
      <div className="relative z-10 bg-card dark:bg-slate-900 border border-border/80 rounded-xl px-4 py-2 text-foreground font-semibold flex items-center justify-center gap-2 group-hover:bg-accent/40 transition-colors">
        {children}
      </div>
    </Component>
  )
