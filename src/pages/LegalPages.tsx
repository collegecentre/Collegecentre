...
export const TermsPage: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8 font-mono">
      ...
      >
        <ArrowLeft className="w-3.5 h-3.5" /> [RETURN TO DESK]
      </button>
      ...
      <div className="space-y-6 text-xs text-foreground/90 leading-relaxed bg-card p-6 border border-black/10 dark:border-white/15">
        <section className="space-y-2">
          <h2 className="text-sm font-bold uppercase tracking-wider text-vermilion">[01] SERVICE SPECIFICATION</h2>
        ...
        <section className="space-y-2">
          <h2 className="text-sm font-bold uppercase tracking-wider text-vermilion">[02] RULE 11 PERMANENT ACCESS GUARANTEE</h2>
          <p className="font-sans">
        ...
        <section className="space-y-2">
          <h2 className="text-sm font-bold uppercase tracking-wider text-vermilion">[03] CANDIDATE CREDENTIALS & ZERO RESUME POLICY</h2>
          <p className="font-sans">
        ...
        <section className="space-y-2">
          <h2 className="text-sm font-bold uppercase tracking-wider text-vermilion">[04] GOVERNING LAW</h2>
          <p className="font-sans">
...
export const PrivacyPolicyPage: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8 font-mono">
      ...
      <div className="border-b border-black/10 dark:border-white/15 pb-6">
        <div className="text-xs uppercase tracking-widest text-muted-foreground mb-1">[PRIVACY // DPDP_ACT]</div>
        <h1 className="text-3xl sm:text-4xl font-black tracking-tight text-foreground font-sans">
          Privacy Policy
        </h1>
        <p className="text-xs text-muted-foreground mt-2">
      ...
      <div className="space-y-6 text-xs text-foreground/90 leading-relaxed bg-card p-6 border border-black/10 dark:border-white/15">
        <section className="space-y-2">
          <h2 className="text-sm font-bold uppercase tracking-wider text-vermilion">[01] INFORMATION COLLECTED</h2>
          <p className="font-sans">
        ...
        <section className="space-y-2">
          <h2 className="text-sm font-bold uppercase tracking-wider text-vermilion">[02] PAYMENT DATA PRIVACY</h2>
          <p className="font-sans">
        ...
        <section className="space-y-2">
          <h2 className="text-sm font-bold uppercase tracking-wider text-vermilion">[03] COOKIES & STORAGE</h2>
          <p className="font-sans">
...
export const RefundPolicyPage: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8 font-mono">
      ...
      <div className="space-y-6 text-xs text-foreground/90 leading-relaxed bg-card p-6 border border-black/10 dark:border-white/15">
        <section className="space-y-2">
          <h2 className="text-sm font-bold uppercase tracking-wider text-vermilion">[01] SPRINT PASS NON-RECURRING NATURE</h2>
          <p className="font-sans">
        ...
        <section className="space-y-2">
          <h2 className="text-sm font-bold uppercase tracking-wider text-vermilion">[02] DIGITAL DELIVERY & CANCELLATION</h2>
          <p className="font-sans">
        ...
        <section className="space-y-2">
          <h2 className="text-sm font-bold uppercase tracking-wider text-vermilion">[03] DUPLICATE & ERRONEOUS CHARGES</h2>
          <p className="font-sans">
...
export const ContactPage: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8 font-mono">
      ...
      <div className="border-b border-black/10 dark:border-white/15 pb-6">
        <div className="text-xs uppercase tracking-widest text-muted-foreground mb-1">[COMMUNICATIONS // DESK]</div>
        <h1 className="text-3xl sm:text-4xl font-black tracking-tight text-foreground font-sans">
          Contact & Support
        </h1>
        <p className="text-xs text-muted-foreground mt-2">
